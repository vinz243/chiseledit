...
import org.vinz243.tesa.commands.TesaCommand;
...
@Mod(
        ...
        name = Chiseledit.MOD_NAME,
        version = Chiseledit.VERSION
)
public class Chiseledit {
     ...
     */
    @Mod.Instance(MOD_ID)
    public static Chiseledit INSTANCE;
    ...
    public void postinit(FMLPostInitializationEvent event) {
        MinecraftForge.EVENT_BUS.register(TesaManager.getInstance());
    }
